...
export const NODES: AvenueNode[] = [
  { id: "lafayette", label: "Lafayette / Putnam", shortLabel: "Lafayette", y: 0.0, side: "terminus" },
  { id: "elm", label: "Elm St", shortLabel: "Elm", y: 0.18, side: "both" },
  { id: "lewis", label: "Lewis Ct", shortLabel: "Lewis", y: 0.34, side: "east" },
  { id: "mason", label: "Mason / Bolling", shortLabel: "Mason", y: 0.5, side: "both" },
  { id: "havemeyer", label: "Havemeyer Pl", shortLabel: "Havemeyer", y: 0.66, side: "east" },
  { id: "arch", label: "Arch St", shortLabel: "Arch", y: 0.82, side: "both" },
  { id: "railroad", label: "Steamboat / Railroad", shortLabel: "Railroad", y: 1.0, side: "terminus" },
];
