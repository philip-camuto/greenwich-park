    ...
    return NextResponse.json(
      {
        ...
        inputs: {
          ...
          traffic: {
            ...
            currentSpeedMph: observation.trafficCurrentSpeedMph,
            freeFlowSpeedMph: observation.trafficFreeFlowSpeedMph,
            trafficSpeedRatio: observation.trafficSpeedRatio,
            tomTomOk: observation.trafficTomTomOk,
          },
          metroNorth: {
